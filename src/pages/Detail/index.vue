            ...
            <div class="detail">
                <div class="fitting">
                    ...
                    <div class="good-suits">
                        <div class="master">
                            <img alt="" src="./images/l-m01.png"/>
                            <p>￥5299</p>
                            <i>+</i>
                        </div>
                        <ul class="suits">
                            <li class="suitsItem">
                                <img alt="" src="./images/dp01.png"/>
                                <p>费勒斯VR</p>
                                <label>
                    ...
                    <div class="tab-content">
                        <div id="one" class="tab-pane active">
                            ...
                            <div class="intro-detail">
                                <img alt="" src="./images/intro01.png"/>
                                <img alt="" src="./images/intro02.png"/>
                                <img alt="" src="./images/intro03.png"/>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            getProductChosenAttrs() {
                ...
                for (let attrDl of attrDls) {
                    const attrName = attrDl.querySelector('dt').innerText;
